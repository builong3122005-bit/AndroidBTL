...
/**
 * AboutUsDialog - Hộp thoại hiển thị thông tin giới thiệu về ứng dụng "Về chúng tôi".
 */
public class AboutUsDialog {
    
    /**
     * Hiển thị hộp thoại giới thiệu ứng dụng lên màn hình.
     */
    public static void show(Context context) {
        ...
        // Thiết lập nội dung văn bản giới thiệu bằng tiếng Việt
    ...
    /**
     * Trả về văn bản giới thiệu ứng dụng bằng tiếng Việt.
     */
