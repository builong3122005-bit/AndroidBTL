...
/**
 * TermsDialog - Hộp thoại hiển thị thông tin "Điều khoản sử dụng" của ứng dụng.
 */
public class TermsDialog {

    /**
     * Hiển thị hộp thoại Điều khoản sử dụng lên màn hình.
     */
    public static void show(Context context) {
        ...
        // Thiết lập nội dung văn bản điều khoản bằng tiếng Việt
        tvTerms.setText(getTermsText());

        AlertDialog dialog = builder.create();
        dialog.show();

        // Sự kiện click nút Đóng để tắt hộp thoại
        btnClose.setOnClickListener(v -> dialog.dismiss());
    }

    /**
     * Trả về văn bản điều khoản sử dụng hoàn toàn bằng tiếng Việt.
     */
